...
[Click here to finish setting up your workspace!](https://snapshot.nx.app/connect/1YVOICH7GZ)
...
```sh
npx nx serve nx-cloud-snapshot
```

To create a production bundle:

```sh
npx nx build nx-cloud-snapshot
```

To see all available targets to run for a project, run:

```sh
npx nx show project nx-cloud-snapshot
```
